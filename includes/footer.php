<footer>
        <div class="clearfix position-relative" id="footer_div">
            <a href="index.php"><img src="img/logo.png" class="img-fluid" id="img_footer" width="80" height="76" alt="Voltar para home"></a>
            <div class="row">
            ...
            <div class="position-absolute bottom-0 start-50 mb-5">
                <a href="https://www.facebook.com/"><i class="bi bi-facebook ms-3 me-3 me-lg-5 ms-lg-5 me-xl-5 ms-xl-5" id="facebook_icon" alt="Ir para o Facebook"></i></a>
                <a href="https://twitter.com/"><i class="bi bi-twitter ms-0" id="twitter_icon" alt="Ir para o Twitter"></i></a>
            </div>
        </div>
</footer>