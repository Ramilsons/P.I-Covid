        ...
        <article id="container">
            <div class="container">
                <div class="row text-center mt-3 mb-5">
                    <h1 class="titulo_principal">Normas de Uso</h1>
                </div>
            </div>
            <section>
                <div class="container" id="container_principal">
                    <div class="row text-center">
                        <h2 class="titulo_termos">Termos e Condições Gerais de Uso</h2>
                    </div>
                    <section>
                    ...
                    <div class="text-start">
                        ...
                        <div class="row mt-4">
                            ...
                            <h4 class="paragrafo_norma">É de responsabilidade da plataforma:
